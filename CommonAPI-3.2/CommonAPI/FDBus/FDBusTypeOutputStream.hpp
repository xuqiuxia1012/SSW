...
#ifndef COMMONAPI_FDBUS_DBUSTYPEOUTPUTSTREAM_H_
#define COMMONAPI_FDBUS_DBUSTYPEOUTPUTSTREAM_H_
 ...
 * 
 */
class FDBusTypeOutputStream: public TypeOutputStream<FDBusTypeOutputStream> {
public:
    FDBusTypeOutputStream() : signature_("") {}
    ...
    TypeOutputStream &writeType(const Struct<Types_...> &_value, const Deployment_ * _depl = nullptr) {
        ...
        StructTypeWriter<Deployment_, itsSize-1, FDBusTypeOutputStream, Struct<Types_...>>{}
            (*this, _value, _depl);
...
#endif // COMMONAPI_FDBUS_DBUSTYPEOUTPUTSTREAM_HPP_
