...
#endif
/*
 * fdb_true: append line-end at the end of each log
 * fdb_false: do not append line-end; assuming line-end is already appended
 */
void fdbLogAppendLineEnd(fdb_bool_t append);
void fdbLogStaticContent(fdb_bool_t enable);
