...
typedef void (*fdb_server_online_fn_t)(struct fdb_server_tag *self, FdbSessionId_t sid,
                                        fdb_bool_t is_first, enum EFdbQOS qos);
typedef void (*fdb_server_offline_fn_t)(struct fdb_server_tag *self, FdbSessionId_t sid,
                                        fdb_bool_t is_last, enum EFdbQOS qos);
