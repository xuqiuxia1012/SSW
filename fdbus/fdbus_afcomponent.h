...
typedef void (*fdb_connection_fn_t)(FdbSessionId_t sid,
                                    fdb_bool_t is_online,
                                    fdb_bool_t is_first,
                                    void *user_data,
                                    enum EFdbQOS qos);
typedef void (*fdb_event_broadcast_fn_t)(fdb_message_t *input_msg);
typedef void (*fdb_message_invoke_fn_t)(fdb_message_t *req_msg,
                                       void *reply_handle);
