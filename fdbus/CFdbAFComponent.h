...
public:
    ...
    tRegistryHandleTbl &getEventRegistryTbl()
    {
    ...
    bool addMsgHandle(CMsgHandleTbl &hdl_table, FdbMsgCode_t code,
    ...
    bool addEvtHandle(CEvtHandleTbl &hdl_table, FdbMsgCode_t code,
    ...
    bool invoke(CFdbBaseObject *obj
                ...
                , int32_t timeout = 0
                , enum EFdbQOS qos = FDB_QOS_DEFAULT);
...
protected:
    std::string mName;
    CBaseWorker *mWorker;
    virtual CBaseClient *createClient(CBaseWorker *worker);
    virtual CBaseServer *createServer(CBaseWorker *worker);
...
private:
    ...
    tRegistryHandleTbl mEventRegistryTbl;
