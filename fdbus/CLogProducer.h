...
namespace ipc {
namespace fdbus {
#define FDB_LOG_QOS FDB_QOS_TRY_SECURE_RELIABLE
...
public:
    ...
    bool static_content() const
    {
        return mStaticContent;
    }
    void set_static_content(bool st)
    {
        mStaticContent = st;
    }
...
public:
    ...
    void logFDBus(CFdbMessage *msg, const char *receiver_name, CBaseEndpoint *endpoint,
                  EFdbQOS session_qos, CFdbRawMsgBuilder &builder);
    void logFDBus(CFdbMessage *msg, const char *receiver_name, CBaseEndpoint *endpoint, EFdbQOS session_qos);
    ...
    void appendLineEnd(bool append)
    {
        mAppendLineEnd = append;
    }
    void staticContent(bool st)
    {
        mStaticContent = st;
    }
protected:
...
private:
    ...
    static bool mAppendLineEnd;
    static bool mStaticContent;
    ...
    void populateWhiteList(const CFdbParcelableArray<std::string> &in_topic
